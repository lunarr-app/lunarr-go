...
func TestInitConfigDefaults(t *testing.T) {
	...
	assert.Empty(t, cfg.TMDb.AccessToken, "Default TMDb access token should be empty")
...
func TestConfigFromYAML(t *testing.T) {
	...
	assert.Empty(t, cfg.TMDb.AccessToken, "Access token should be empty if not provided")
...
func TestConfigWithEnvVars(t *testing.T) {
	...
	os.Setenv("LUNARR_TMDB_ACCESS_TOKEN", "env_access_token")
	...
	defer os.Unsetenv("LUNARR_TMDB_ACCESS_TOKEN")
	...
	assert.Equal(t, "env_access_token", cfg.TMDb.AccessToken, "Access token should be overridden by environment variable")

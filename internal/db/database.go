...
func init() {
	...
	logger.Log.Info().Msg("Creating new MongoClient instance")
	...
	logger.Log.Info().Msg("Exporting MongoDB collections as typed objects")
	...
	logger.Log.Info().Msg("Creating indexes on relevant fields for improved query performance")
	...
	logger.Log.Info().Msg("Creating text indexes for improved searching performance")
